Product.seed(
  ...
  { id: 12, title: 'フルーツ詰め合わせ', price: 2200, quantity: 1, content: '丹精込めて作ったフルーツです！ご賞味あれ！！', harvest_date: '2020-08-10', farm_name: '西条農園', farm_street_address: '愛媛県西条市明屋敷1-6-4', producer_id: 9 },
  ...
  { id: 15, title: 'さくらんぼの詰め合わせ', price: 2100, quantity: 2, content: '山形といえばさくらんぼ！徹底した管理のもとで育ったうちの商品は何処にも負けません。', harvest_date: '2020-08-15', farm_name: '米沢農場', farm_street_address: '山形県米沢市金池5-2-25', producer_id: 6 },
  ...
  # { id: 25, title: 'さくらんぼの詰め合わせ', price: 2100, quantity: 2, content: '山形といえばさくらんぼ！徹底した管理のもとで育ったうちの商品は何処にも負けません。', harvest_date: '2020-08-15', farm_name: '米沢農場', farm_street_address: '山形県米沢市金池5-2-25', producer_id: 4 },
