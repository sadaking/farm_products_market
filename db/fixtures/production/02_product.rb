Product.seed(
  ...
  { id: 25, title: '野菜詰め合わせ', price: 1900, quantity: 1, content: '名店からの注文が絶えない、新鮮な野菜たちです！！', harvest_date: '2020-08-07', farm_name: '旭川農園', farm_street_address: '北海道旭川市6条通り6-9', producer_id: 7 },
